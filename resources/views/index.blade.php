            ...
            <div class="col-md-6 d-flex rounded">
                <form action="{{route('landing.index')}}" method="POST" id="search-mission" style="margin: 0%; padding:0%;">
                    ...
                    <div class="d-flex">
                        ...
                        <div>
                            <input type="search" name="s" id="search_input" placeholder="Search Missions... " value='{{ request()->input('s') }}' class="form-control border-0" />
                        </div>
                    </div>
                </form>
            </div>
...
<div class=" container  py-3">
    <div class="d-flex py-4 justify-content-between">
        ...
        <div class="d-flex">
            ...
            <div class='d-flex px-3 justify-content-center align-items-center'>
                ...
                <label id="grid-view-label" class="btn p-1 rounded-circle" for="grid-view"><img src={{ asset('Images/grid.png') }} alt=""></label>
                <input type="radio" class="btn-check px-1" name="view" id="list-view">
                <label id="list-view-label" class="btn p-2 rounded-circle" value='1' for="list-view"><img src={{ asset('Images/list.png') }} alt=""></label>
            </div>
        </div>
    </div>
    {{--gridViewContent--}}
    <div id="gridViewContent" class="row py-3" id="missions" >
        ...
        <div class="card col-lg-6 col-xl-4 col-md-6 border-0  pb-4 text-center" >
            <div class="py-1" style="box-shadow: rgba(0, 0, 0, 0.25) 0px 14px 28px, rgba(0, 0, 0, 0.22) 0px 10px 10px;">
                    ...
                    <span class="position-absolute parent_mission_location">
                        <span class="mission_location px-2 py-1">
                            <img src={{ asset('Images/pin.png') }} alt="">
                                <span class="text-white px-2">{{ $item->City->name ?? 'cabina'   }}</span>
                        </span>
                    </span>
                </div>
            </div>
            <div class="text-center" style="margin-top: -25px" style="box-shadow: rgba(0, 0, 0, 0.25) 0px 14px 28px, rgba(0, 0, 0, 0.22) 0px 10px 10px;">
            ...
            <div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.25) 0px 14px 28px, rgba(0, 0, 0, 0.22) 0px 10px 10px;">
                ...
                <div class="d-flex justify-content-center">
                    <form action="{{route('mission-page',$item->mission_id)}}">
                        <button type="submit" class="btn btn-lg fs-5 apply-btn"> Apply <i class="fa-sharp fa-solid fa-arrow-right"></i> </button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="row" style="box-shadow: rgba(0, 0, 0, 0.25) 0px 14px 28px, rgba(0, 0, 0, 0.22) 0px 10px 10px;">
            <div class="col-md-4 py-2 text-center">
                ...
                <span class="position-absolute parent_mission_location_l">
                    <span class="mission_location px-2 py-1">
                        <img src={{ asset('Images/pin.png') }} alt=""><span class="text-white px-2">{{ $item->City->name ?? 'yoker' }}</span>
        ...
        <div class="col p-2">
            <div class="row align-items-start">
                <div class="col">
                    <div class="d-flex">
                        <div>
                            <img src="{{asset('Images/pin1.png')}}" alt=""> {{$item->name}}
                            {{--  //cot  --}}
                        </div>
                        <div class="px-2">
            ...
            <div class="row justify-content-between">
                        ...
                        <div class="col-lg-6">
                            <div class="d-flex">
                                ...
                                <div class='d-flex align-items-center'>
                                    ...
                                    <div class=" px-2 d-flex flex-column align-items-start">
                                        <div class="progress ">
                                            <div class="progress-bar bg-warning" role="progressbar" style="width: 100%" aria-valuenow="75" aria-valuemin="80" aria-valuemax="100"></div>
                                        </div>
                ...
                <div class="col-md-3">
                    ...
                    <form action="{{route('mission-page',$item->mission_id)}}">
                        <button type="submit" class="btn btn-lg fs-5 apply-btn"> View Details <i class="fa-sharp fa-solid fa-arrow-right"></i> </button>
                    </form>
                </div>
            </div>
        </div>
