        ...
        <div class="row">
            ...
            <div class="col-md-6 d-flex rounded">
                <form action="{{route('landing.index')}}" method="GET" id="search-mission" style="margin: 0%; padding:0%;">
                    <div class="d-flex">
                        ...
                        <div>
                            <input type="search" name="search" id="search_input" placeholder="Search Missions... " value='{{ request()->input('s') }}' class="form-control border-0" />
                        </div>
                    </div>
                </form>
            </div>
            <div class="col-md-6 d-flex justify-content-around">
                ...
                <div class="border-start input-group h-100 px-2">
                    <select class="custom-select w-100 border-0 text" name="country_id" id="country-dropdown">
                ...
                <div class="border-start input-group px-2">
                    <select class="custom-select w-100 border-0" name="city_id" id="city-dropdown">
                        <option disabled selected> city </option>
                    </select>
                </div>
                <div class="border-start input-group px-2">
                    <select class="custom-select  w-100 border-0" name="mission_theme_id" id="theme-dropdown">
                ...
                <div class="border-start border-end input-group px-2">
                    <select class="custom-select  w-100 border-0" id="skill-dropdown">
...
<div class=" container  py-3">
    <div class="d-flex py-4 justify-content-between">
        <div>
            <h4>
                <span class="light-theme-color">Explore</span> <span class="theme-color" id="noOfMission">{{$count}}
                    Mission
                </span>
            </h4>
        </div>
                ...
                <div class="position-relative">
                    ...
                    <span class="position-absolute parent_mission_location">
                        <span class="mission_location px-2 py-1">
                            <img src={{ asset('Images/pin.png') }} alt=""><span class="text-primary px-2">{{ $item->country->name }}</span>
                        </span>
                    </span>
                </div>
            </div>
                        ...
                        <div class="d-flex py-3 justify-content-between">
                            ...
                            <div class="d-flex align-items-center ">
                                ...
                                <div class="px-2 d-flex flex-column align-items-start">
                                    <span class="theme-color fs-5 font-weight-bolder">555 <br></span>
                            ...
                            <div class='d-flex align-items-center'>
                                ...
                                <div class=" px-2 d-flex flex-column align-items-start">
                                    <span class="theme-color fs-5 font-weight-bolder">cccccccccccc <br></span>
