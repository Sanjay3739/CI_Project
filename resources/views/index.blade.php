                ...
                <div class="position-relative">
                    ...
                    <span class="position-absolute parent_mission_location">
                        <span class="mission_location px-2 py-1">
                            <img src={{ asset('Images/pin.png') }} alt=""><span class="text-white px-2">{{ $item->city->name?? 'Windwardside' }}</span>
                        </span>
                    </span>
                </div>
        ...
        <div class="col p-2">
            <div class="row align-items-start">
                <div class="col">
                    <div class="d-flex">
                        <div>
                            <img src="{{asset('Images/pin1.png')}}" alt=""> {{$item->city->name?? 'Windwardside'}}
                        </div>
                        <div class="px-2">
                        ...
                        <div class="col-lg-6">
                            <div class="d-flex">
                                ...
                                <div class='d-flex align-items-center'>
                                    ...
                                    <div class=" px-2 d-flex flex-column align-items-start">
                                        <small class="p-2 fs-6 theme-color"> Skills <br> {{$item->skill_name}}</small>
                                    </div>
                                </div>
                            </div>
                        </div>
