        ...
        <div class="row">
            <div class="col-md-12">
                <div class="container-fluid px-1">
                    <h3 class="mt-4" style="color: blue">Banner Management</h3>
                    <ol class="breadcrumb mb-4 w-25" style=" box-shadow: 5px 5px 5px rgba(62, 60, 60, 0.6);">
                        <li class="breadcrumb-item active in" style="color:#000000">Banner-Add</li> <svg
            ...
            <div class=" col-md-12 card-header"  style=" box-shadow: rgba(0, 0, 0, 0.25) 0px 14px 28px, rgba(0, 0, 0, 0.22) 0px 10px 10px;">
              ...
              <form action="{{ route('banner.add') }}" method="POST" enctype="multipart/form-data" class="w-75 mt-3">
                @csrf
