            ...
            <div class="tab-content">
                <div class="tab-pane show active" id="userc">
                    <div class="table-responsive">
                        <table class="table table-responsive-lg table-responsive-md text-center">
                            <thead class="thead-light border-bottom">
                                <tr>
                                    <th class="p-3 pe-0 fs-6" scope="col">Story Title</th>
                                    <th class="p-3 pe-0 fs-6" scope="col">Full Name</th>
                                    <th class="p-3 pe-0 fs-6" scope="col">Mission Title</th>
                                    <th class="p-3 pe-0 fs-6" scope="col">Action</th>
                                </tr>
                            </thead>
                            <tbody>
