                                    ...
                                    <tr>
                                        ...
                                        <td class="p-2 pe-0 p-0 fs20">
                                            ...
                                            <a href="{{ route('story.show', $story->story_id) }}">
                                                <svg width="27" height="27" clip-rule="evenodd" fill-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            {{--  <button type="submit btn-lg btn-sm" class="btn btn-outline-danger" data-toggle="modal" data-target="#deleteModal-{{ $story->story_id }}" class="btn btn-white">
                                                Delete
                                            </button>  --}}

                                            <button type="button" data-toggle="modal" data-target="#deleteModal-{{ $story->story_id }}" class="btn btn-white">
                                                <svg width="27" height="27" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd">
