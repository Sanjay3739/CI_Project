            ...
            <div class="col-lg-12" style=" box-shadow:5px 5px 5px 5px rgba(62, 60, 60, 0.6);">
                ...
                <div class="">
                    <div class="d-flex justify-content-between m-3">
                        <form class="m-0" action="{{ route('story.index') }}" method="PUT"
                        ...
                        <div class="tab-pane show active" id="userc">
                            <div class="table-responsive">
                                <table class="table table-responsive-lg table-hover table-responsive-md text-center">
                                                ...
                                                <td class="p-2 pe-0 p-0 fs20">
                                                    ...
                                                    <a href="approve/{{ $story->story_id }}" class="green">
                                                        <svg clip-rule="evenodd" fill-rule="evenodd" stroke-linejoin="round"
                                                            stroke-miterlimit="2" height="35" width="35"
                                                    ...
                                                    <a href="decline/{{ $story->story_id }}" class="red">
                                                        <svg clip-rule="evenodd" fill-rule="evenodd"
                                                            href="story/decline{{ $story->story_id }}"
                                                            stroke-linejoin="round" stroke-miterlimit="2" height="35"
                                                            width="35" viewBox="0 0 24 24"
                                                    ...
                                                    <button type="submit"
                                                        ...
                                                        data-target="#deleteModal-{{ $story->story_id }}"
                                                        class="btn btn-white">
                                                       Delete
                                                    </button>
                                    ...
                                    <tfoot
                                        style=" border:none ; box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px;">
                                        <tr>
