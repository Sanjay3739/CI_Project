            ...
            <div class="row">
                <div class="col-lg-4">
                    <table class="table table-striped w-75 ">
                        <tbody>
                            <th>Story Title</th>
                            <tr>
                                <td> {{ $story->story_title  ?? 'ssnsnsnsnn'}} </td>
                            </tr>
                            <th>Mission Title</th>
                            <tr>
                                <td> {{ $story->title ?? 'bbbbb'}} </td>
                            </tr>
                            <th>Story Description</th>
                            <tr>
                                <td> {{ strip_tags($story->story_desc ?? 'ddd') }}</td>
                            </tr>
                        </tbody>
                    </table>
                    <table>
                            ...
                            <tr>
                                <th>
                                    <div class="d-flex justify-content-between ">
                                        ...
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#popup{{ $story->story_id ?? 'wwww'}}" class="btn btn-outline-danger me-2 col-example">Delete</a>
                                        <div id="popup{{ $story->story_id ?? 'wwww' }}" class="modal">
                ...
                <div class="col-lg-4" style=" flex-direction:column">
                    ...
                    <div class="sa">
                        ...
                        @if($media->type != 'video')
                        <img class="m-3" src="{{ ($media->path) }}" height="200px" width="250px" value="" crossorigin="anonymous">
                        @endif
                        @endforeach
                    </div>
                ...
                <div class="col-lg-4" style=" flex-direction:column">
                    ...
                    <div class="tag ">@foreach ($medias as $media)
