    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card" style=" box-shadow: rgba(0, 0, 0, 0.25) 0px 14px 28px, rgba(0, 0, 0, 0.22) 0px 10px 10px;">
                ...
                <table class="table table-hover  table-bordered table-responsive-lg table-responsive-md ">
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="6"> @if (request()->input('search') == '')
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination pager justify-content-start mt-2">
                                        @php
                                        $next = $page + 1;
                                        $previous = $page - 1;
                                        @endphp
                                        ...
                                        @else
                                        <li class='page-item'><a class='page-link peginate' href='/application?page=1'><img src='/images/previous.png' alt=''></a></li>
                                        <li class='page-item'><a class='page-link peginate' href='/application?page={{ $previous }}'><img src='/images/left.png' alt=''></a></li>
                                        @endif
                                        @for ($i = 1; $i <= $cnt; $i++) @if ($i==$page) <li class='page-item'><a class='page-link active text-center peginate p-0 pt-1' href='application?page={{ $i }}'><b>{{ $i }}</b></a>
                                            </li>
                                            @else
                                            <li class='page-item'><a class='page-link text-center text-dark peginate p-0 pt-1' href='application?page={{ $i }}'>{{ $i }}</a></li>
                                            @endif
                                            @endfor
                                            @if ($page == $cnt)
                                            ...
                                            @else
                                            <li class='page-item'><a class='page-link peginate' href='/application?page={{ $next }}'><img src='/images/arrow.png' alt=''></a></li>
                                            <li class='page-item'><a class='page-link peginate' href='/application?page={{ $cnt }}'><img src='/images/next.png' alt=''></a></li>
                                            @endif
                                    </ul>
                                </nav>
                                @endif
