            ...
            <tbody>
                ...
                @foreach ($missionApplications as $missionApplication)
                    <tr>
                        ...
                        <td>
                            <form
                                action="{{ route('mission-applications.update', $missionApplication->mission_application_id) }}"
                                method="POST">
                                @csrf
                                @method('PUT')
                        ...
                        <td>
                            <form
                                action="{{ route('mission-applications.destroy', $missionApplication->mission_application_id) }}"
                                method="POST">
                                @csrf
                                @method('DELETE')
