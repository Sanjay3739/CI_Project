        ...
        <div class="sb-sidenav-menu align-content-center">
            <div class="nav">
                ...
                <a class="nav-link" href="{{route('user.index')}}">
                    <div class='container'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24">
                            <path id="path" d="M19 7.001c0 3.865-3.134 7-7 7s-7-3.135-7-7c0-3.867 3.134-7.001 7-7.001s7 3.134 7 7.001zm-1.598 7.18c-1.506 1.137-3.374 1.82-5.402 1.82-2.03 0-3.899-.685-5.407-1.822-4.072 1.793-6.593 7.376-6.593 9.821h24c0-2.423-2.6-8.006-6.598-9.819z" /></svg>
                ...
                <a class="nav-link" href="/cmspage">
                    <div class='container'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24">
                            <path id="path" d="M14.568.075c2.202 1.174 5.938 4.883 7.432 6.881-1.286-.9-4.044-1.657-6.091-1.179.222-1.468-.185-4.534-1.341-5.702zm7.432 10.925v13h-20v-24h8.409c4.857 0 3.335 8 3.335 8 3.009-.745 8.256-.419 8.256 3zm-16 5h5v-4h-5v4zm12 2h-12v1h12v-1zm0-3h-5v1h5v-1zm0-3h-5v1h5v-1z" /></svg>
                        <span class="text-white font-weight-light ">
                            CMS Page
                        </span>
                    </div>
                ...
                <a class="nav-link" href="/missiontheme">
                    <div class='container-fluid'>
                        <svg clip-rule="evenodd" width="17" height="17" stroke-linejoin="round" stroke-miterlimit="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <a class="nav-link" href="/mission-applications">
                    <div class='container'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24">
                            <path id="path" d="M11 5c-1.629 0-2.305-1.058-4-3h-7v20h24v-17h-13z" /></svg>
                ...
                <a class="nav-link" href="/story">
                    <div class='container'>
                        <svg width="17" height="17" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" clip-rule="evenodd">
                            <path id="path" d="M22 24h-17c-1.657 0-3-1.343-3-3v-18c0-1.657 1.343-3 3-3h17v24zm-2-4h-14.505c-1.375 0-1.375 2 0 2h14.505v-2zm-3-15h-10v3h10v-3z" /></svg>
                        <span class="text-white ">
                            Story
                        </span>
                    </div>
