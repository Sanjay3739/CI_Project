    ...
    <div class="card mb-4" style=" box-shadow: rgba(0, 0, 0, 0.25) 0px 14px 28px, rgba(0, 0, 0, 0.22) 0px 10px 10px;">
        ...
        <div class="card-body">
            ...
            <form action="{{route('missionskill.update',$skill->skill_id)}}" method="post">
                ...
                <div class="py-4">
                    <label class="float-start m-1    px-2" for="options-outlined">
                        <h5>Status: </h5>
                    </label>
                    <input type="radio" class="btn-check " name="status" value='1' id="success-outlined" @if($skill->status==1) checked @endif>
                    <label class="btn btn-outline-success px-3" for="success-outlined">Active</label>

                    <input type="radio" class="btn-check" value='0' name="status" id="danger-outlined" @if($skill->status==0) checked @endif>
