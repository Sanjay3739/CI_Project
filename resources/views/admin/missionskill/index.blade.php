    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="container-fluid px-1">
                ...
                <marquee class="breadcrumb mb-4 w-25 " style=" background: linear-gradient(to left, #069ce6, #d00288, #f79809);box-shadow: 5px 5px 5px rgba(62, 60, 60, 0.6);">
                    Skill-Index
                ...
                <button type="button" class="btn rounded mb-3 text-right btn btn-outline-success" style="box-shadow: rgba(14, 30, 37, 0.12) 0px 2px 4px 0px, rgba(14, 30, 37, 0.32) 0px 2px 16px 0px;">
        ...
        <div class="col-lg-12 ">
            <div class="card" style=" box-shadow: rgba(0, 0, 0, 0.25) 0px 14px 28px, rgba(0, 0, 0, 0.22) 0px 10px 10px;">
                ...
                <div class="d-flex justify-content-between m-3">
                    <form class="m-0" action="{{ route('missionskill.index') }}" method="GET" enctype="multipart/form-data">
                        @csrf
                        <div class="rb">
        ...
        <div class="col-lg-12">
            <table class="table table-hover table-bordered text-center table-responsive-lg  table-responsive-md table-responsive-sm" style=" box-shadow: rgba(0, 0, 0, 0.25) 0px 14px 28px, rgba(0, 0, 0, 0.22) 0px 10px 10px;">
                    ...
                    <tr>
                        ...
                        <td class="fs-20">
                            <form class="justify-content-between " action="{{ route('missionskill.destroy', $mt->skill_id) }}" method="Post">
                                <a href="{{ route('missionskill.edit', $mt->skill_id) }}" class="btn mt-2 btn-warning btn-sm">Edit</a>
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn mt-2 btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this item?')">Delete</button>
                            </form>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
                <tfoot style=" box-shadow: rgba(0, 0, 0, 0.25) 0px 14px 28px, rgba(0, 0, 0, 0.22) 0px 10px 10px; border:none">
                    <tr>
                        <td colspan="5"> {!! $data->links('pagination::bootstrap-4') !!}</td>
                    </tr>
                </tfoot>
            </table>
