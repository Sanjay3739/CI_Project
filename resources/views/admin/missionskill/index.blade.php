            ...
            <div class="col-lg-12">
                <div class="container-fluid px-1">
                    ...
                    <marquee class="breadcrumb mb-4 w-25 " id="marquee"
                        style=" background: linear-gradient(to left, #069ce6, #d00288, #f79809);box-shadow: 5px 5px 5px rgba(62, 60, 60, 0.6);">
                        Skill-Index
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 mw-100"
                    ...
                    <div class="d-flex justify-content-between m-3">
                        <form class="m-0" action="{{ route('missionskill.index') }}" method="PUT"
                            ...
                            <div class="rb">
                                <div class="input-group">
                                    ...
                                    <input type="text" value="{{ request()->input('rat') }}" name="rat"
                        ...
                        <div class="card add_btn ">
                            ...
                            <button type="button" class="btn rounded text-right btn btn-outline-success" style="box-shadow: rgba(14, 30, 37, 0.12) 0px 2px 4px 0px, rgba(14, 30, 37, 0.32) 0px 2px 16px 0px;" >
                        ...
                        <tbody>
                            @foreach ($data as $mt)
                                <tr>
                                    ...
                                    <td class="fs-20">
                                        <a href="{{ route('missionskill.show', $mt->skill_id) }}"
                                            class="btn mt-2 btn-outline-primary btn-sm">View</a>
                                        <a href="{{ route('missionskill.edit', $mt->skill_id) }}"
                                            class="btn mt-2 btn-outline-warning btn-sm">Edit</a>
                                ...
                                <button type="submit" class="btn mt-2 btn-outline-danger btn-sm" onclick="return confirm('Are you sure you want to delete this item?')">Delete</button>
                                        ...
                                        <button type="submit" class="btn mt-2 btn-outline-danger btn-sm"
                                            data-toggle="modal" data-target="#deleteModal-{{ $mt->skill_id }}"
                                            class="btn btn-white">
                                            Delete
