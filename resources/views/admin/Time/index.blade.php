        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="d-flex justify-content-between m-3">
                    <form class="m-0" action="{{ route('time') }}" method="PUT" enctype="multipart/form-data">
                        @csrf
                        <div class="rb">
                            <div class="input-group">
                                ...
                                <input type="text" name="rat" value="{{ request()->input('rat') }}" placeholder="search"
                                ...
                                <td class="fs-20">
                                    <a href="tapprove/{{ $time->timesheet_id }}">
                                        <svg clip-rule="evenodd" fill-rule="evenodd"
                                            href="tapprove/{{ $time->timesheet_id }}" stroke-linejoin="round"
                                    ...
                                    <a href="tdecline/{{ $time->timesheet_id }}">
                                        <svg clip-rule="evenodd" fill-rule="evenodd"
                                            href="tdecline/{{ $time->timesheet_id }}" stroke-linejoin="round"
                                            stroke-miterlimit="2" height="35" width="35" viewBox="0 0 24 24"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path id="red"
