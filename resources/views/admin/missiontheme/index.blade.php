        ...
        <div class="col-lg-12">
            <div class="card" id="card">
                ...
                <div class="d-flex justify-content-between m-3">
                    <form class="m-0" action="{{ route('missiontheme.index') }}" method="PUT"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    {{-- <a href="javascript:void(0)" id="showtheme"
                                        data-url="{{ route('missiontheme.show', $item->mission_theme_id) }}"> <svg
                                    ...
                                    {{--  <a href="{{ route('missiontheme.show', $item->mission_theme_id) }}" class="btn
                                    ...
                                    {{--  <a href="{{ route('missiontheme.edit', $item->mission_theme_id) }}" class="btn
                                    ...
                                    {{--  <button type="submit" class="btn btn-outline-danger btn-sm" data-toggle="modal" data-target="#deleteModal-{{$item->mission_theme_id }}"
                                    class="btn btn-white">
                                    Delete
                                    </button> --}}
...
{{-- <div class="modal fade" id="userShowModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">SKill Data</h5>
                ...
                <div class="modal-body">
                    ...
                    <p> <strong>Id:</strong> <span id="theme-id"></span></p>

                    <p> <strong>Title:</strong> <span id="theme-title"></span></p>

                    <p> <strong>Status:</strong> <span id="theme-status"></span></p>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('body').on('click', '#showtheme', function() {

                var userURL = $(this).data('url');
                $.get(userURL, function(data) {

                    $('#userShowModal').modal('show');
                    $('#theme-id').text(data.mission_theme_id);
                    $('#theme-title').text(data.title);
                    if (data.status == 0) {
                        $('#theme-status').addClass('text-danger').text('inactive');
                    } else {

                        $('#theme-status').addClass('text-success').text('active');
                    }
