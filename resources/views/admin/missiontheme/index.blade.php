    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card" style=" box-shadow: rgba(0, 0, 0, 0.25) 0px 14px 28px, rgba(0, 0, 0, 0.22) 0px 10px 10px;">
                ...
                <div class="pagination p-2" style="box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px;">
...
@endsection
 ...
 {{-- <div class="d-flex justify-content-between mt-4 mb-4">
                    ...
                    <form class="m-0" action="{{ route('missiontheme.index') }}" method="GET">
                @csrf
                <div class="rb">
                    <div class="input-group">
                        <span class="input-group-text rbc">
                        ...
                        <input type="text" name="search" class="text-sm " placeholder="Search..." />
                    </div>
                </div>
            ...
            @csrf
            <input type="text" name="search" class="block w-full mt-3  p-4 pl-10 text-sm " placeholder="Search..." style=" box-shadow: 0 15px 10px #e98585, 0 0 0 20px #ffffffeb;" />
            </form>
        </div>
    </div> --}}
