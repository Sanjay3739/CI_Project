        ...
        <div class="col-lg-12">
            <div class="card mb-4"
                ...
                <div class="card-header">
                    <h5>Enter Data - {{ $data->mission_theme_id }} </h5>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('missiontheme.update', $data->mission_theme_id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                                id="titles" value="{{ $data->title }}" placeholder="" >
                            ...
                            <tr>
                                <td>
                                    <div class="card-body btns justify-content d-flex justify-content-between w-25">
                                        <a href="{{ route('missiontheme.index') }}"
                                            class="btn btn-outline-dark">Back</a>
                                        <button type="submit"
                                            class="btn justify-content-center btn-outline-warning">Save</button>
                                    </div>
                                </td>
                            </tr>
                        </tfoot>
