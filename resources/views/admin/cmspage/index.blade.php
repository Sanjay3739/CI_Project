        ...
        <div class="card-body">
            <div class="d-flex align-items-center justify-content-between mt-1 mb-4">
                <div class="relative max-w-xs">
                    <form class="m-0" action="{{ route('cmspage.index') }}" method="GET" enctype="multipart/form-data">
                        @csrf
                        <div class="rb">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" data-toggle="modal" data-target="#deleteModal-{{ $data->cms_page_id }}" class="btn btn-white">
