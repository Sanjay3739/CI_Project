                    ...
                    <div class="form-row py-4" id="imggroup">
                        <div class="form-check" id="img">
                            ...
                            <label class="form-check-label" for="avatar1">
                                <img class="rounded-circle" height="50px" width="50px" src="../Images/volunteer1.png" alt="Alt Images">
                            </label>
                        </div>
                        <div class="form-check" id="img">
                            <input class="form-check-input" value="Images/volunteer2.png" type="radio" name="avatar" id="avatar1">
                            <label class="form-check-label" for="avatar1">
                                <img class="rounded-circle" height="50px" width="50px" src="../Images/volunteer2.png" alt="Alt Images">
                            </label>
                        </div>
                        <div class="form-check" id="img">
                            <input class="form-check-input" value="Images/volunteer3.png" type="radio" name="avatar" id="avatar1">
                            <label class="form-check-label" for="avatar1">
                                <img class="rounded-circle" height="50px" width="50px" src="../Images/volunteer3.png" alt="Alt Images">
                            </label>
                        </div>
                        <div class="form-check" id="img">
                            <input class="form-check-input" value="Images/volunteer4.png" type="radio" name="avatar" id="avatar1">
                            <label class="form-check-label" for="avatar1">
                                <img class="rounded-circle" height="50px" width="50px" src="../Images/volunteer4.png" alt="Alt Images">
                            </label>
                        </div>
                        <div class="form-check" id="img">
                            <input class="form-check-input" value="Images/volunteer5.png" type="radio" name="avatar" id="avatar1">
                            <label class="form-check-label" for="avatar1">
                                <img class="rounded-circle" height="50px" width="50px" src="../Images/volunteer5.png" alt="Alt Images">
                            </label>
                        </div>
                        <div class="form-check" id="img">
                            <input class="form-check-input" value="Images/volunteer6.png" type="radio" name="avatar" id="avatar1">
                            <label class="form-check-label" for="avatar1">
                                <img class="rounded-circle" height="50px" width="50px" src="../Images/volunteer6.png" alt="Alt Images">
                            </label>
                        </div>
                        <div class="form-check" id="img">
                            <input class="form-check-input" value="Images/volunteer7.png" type="radio" name="avatar" id="avatar1">
                            <label class="form-check-label" for="avatar1">
                                <img class="rounded-circle" height="50px" width="50px" src="../Images/volunteer7.png" alt="Alt Images">
                            </label>
                        </div>
                        <div class="form-check" id="img">
                            <input class="form-check-input" value="Images/volunteer8.png" type="radio" name="avatar" id="avatar1">
                            <label class="form-check-label" for="avatar1">
                                <img class="rounded-circle" height="50px" width="50px" src="../Images/volunteer8.png" alt="Alt Images">
                            </label>
                        </div>
                        <div class="form-check" id="img">
                            <input class="form-check-input" value="Images/volunteer9.png" type="radio" name="avatar" id="avatar1">
                            <label class="form-check-label" for="avatar1">
                                <img class="rounded-circle" height="50px" width="50px" src="../Images/volunteer9.png" alt="Alt Images">
                            </label>
                        </div>
                    </div>
