...
<div class="container-fluid px-4">
    ...
    <div class="card mb-4" id="bs">
        ...
        <div class="card-body">
            <div class="container">
                <form action="{{route('user.update',$user->user_id)}}" method="post" id="fom">
