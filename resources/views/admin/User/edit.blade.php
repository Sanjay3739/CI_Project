                        ...
                        <div class="container" style="box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px;">
                            <form class="m-3" action="{{ route('user.update', $user->user_id) }}" method="post">
                                ...
                                <div class="form-row justify-content-between">
                                    ...
                                    <div class="col-md-6 py-4"> {{-- This is submit button --}}
                                        <button class="btn btn-outline-warning pull-right" type="submit"><i class="fa-solid fa-pen-to-square text-outline-black"></i> Update</button>
                                    </div>
                                </div>
                            </form>
                        </div>
