...
@section('body')
    <div class="container-fluid px-4">
        ...
        <ol class="breadcrumb mb-4 w-25" style=" box-shadow: 5px 5px 5px rgba(62, 60, 60, 0.6);">
            ...
            <li class="breadcrumb-item active" style="color: #000">User-Edits</li>
        ...
        <div class="card mb-4" style="box-shadow: rgba(0, 0, 0, 0.19) 0px 10px 20px, rgba(0, 0, 0, 0.23) 0px 6px 6px;">
            ...
            <div class="card-body">
                <div
                    class="container"style="box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px;">
                    <form class="m-3" action="{{ route('user.update', $user->user_id) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="form-row py-4">
                            <div class="form-check">
                                <input class="form-check-input  ml-0" value="Images/volunteer1.png" type="radio"
                                    name="avatar" id="avatar1" checked>
                            ...
                            <div class="form-check">
                                <input class="form-check-input  ml-0" value="Images/volunteer2.png" type="radio"
                            ...
                            <div class="form-check">
                                <input class="form-check-input  ml-0" value="Images/volunteer3.png" type="radio"
                                    name="avatar" id="avatar1">
                                <label class="form-check-label  p-2 imges" for="avatar1">
                                    <img class="rounded-circle" height="100px" width="100px"
                            ...
                            <div class="form-check">
                                <input class="form-check-input  ml-0" value="Images/volunteer4.png" type="radio"
                                    name="avatar" id="avatar1">
                                <label class="form-check-label  p-2 imges" for="avatar1">
                                    <img class="rounded-circle" height="100px" width="100px"
                            ...
                            <div class="form-check">
                                <input class="form-check-input  ml-0" value="Images/volunteer5.png" type="radio"
                                    name="avatar" id="avatar1">
                                <label class="form-check-label  p-2 imges" for="avatar1">
                                    <img class="rounded-circle" height="100px" width="100px"
                            ...
                            <div class="form-check">
                                <input class="form-check-input  ml-0" value="Images/volunteer6.png" type="radio"
                                    name="avatar" id="avatar1">
                                <label class="form-check-label  p-2 imges" for="avatar1">
                                    <img class="rounded-circle" height="100px" width="100px"
                            ...
                            <div class="form-check">
                                <input class="form-check-input  ml-0" value="Images/volunteer7.png" type="radio"
                                    name="avatar" id="avatar1">
                                <label class="form-check-label  p-2 imges" for="avatar1">
                                    <img class="rounded-circle" height="100px" width="100px"
                            ...
                            <div class="form-check">
                                <input class="form-check-input  ml-0" value="Images/volunteer8.png" type="radio"
                                    name="avatar" id="avatar1">
                                <label class="form-check-label  p-2 imges" for="avatar1">
                                    <img class="rounded-circle" height="100px" width="100px"
                            ...
                            <div class="form-check">
                                <input class="form-check-input" value="Images/volunteer9.png" type="radio"
                                    name="avatar" id="avatar1">
                                <label class="form-check-label  p-2 imges" for="avatar1">
                                    <img class="rounded-circle" height="100px" width="100px"
                        ...
                        <div class="form-row justify-content-left">
                            <div class="col-md-4 py-4">
                                ...
                                <input type="radio" class="btn-check form-control" value='0' name="status"
                                    id="danger-outlined">
                            ...
                            <div class="col-md-4 py-4"> {{-- This is submit button --}}
                                <button class="btn btn-warning pull-right" type="submit"><i
