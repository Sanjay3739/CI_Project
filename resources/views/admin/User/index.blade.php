...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <marquee class="breadcrumb mb-4 w-25" id="marquee" style=" background: linear-gradient(to left, #069ce6, #d00288, #f79809); color:#000000 ;box-shadow: 5px 5px 5px rgba(62, 60, 60, 0.6);">
                User-Index
