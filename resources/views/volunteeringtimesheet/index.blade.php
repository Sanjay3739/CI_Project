...
<div class="container mt-5 pt-5">
    ...
    <div class="row">
        <div class="col-lg-6 border mt-3">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="modal fade" id="editVolunteerHourModal-{{ $timesheet->timesheet_id }}" tabindex="-1" aria-labelledby="volunteerhourModalLabel" aria-hidden="true" role="dialog">
                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form id="editTimeTimesheetForm-{{ $timesheet->timesheet_id }}" method="POST">
                                                @csrf
                                                @method('PUT')
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="missionSelect" name="mission_id">
                                                        ...
                                                        <option value="{{ $mission->mission_id }}" {{ $mission->mission_id == $timesheet->mission_id ? 'selected' : '' }}>
                                                            {{ $mission->title }}
                                                ...
                                                <div class="form-group  mt-3">
                                                    ...
                                                    <input type="date" class="form-control" id="dateVolunteered" name="date_volunteered" value="{{ \Carbon\Carbon::parse($timesheet->date_volunteered)->format('Y-m-d') }}">
                                                </div>
                                                <div class="form-group  mt-3">
                                                    <label for="hoursVolunteered">Hours</label>
                                                    <input type="number" class="form-control" id="hoursVolunteered" placeholder="Enter Spent Hours" min="0" name="hour" value="{{ date('H', strtotime($timesheet->time)) }}">
                                                </div>
                                                <div class="form-group  mt-3">
                                                    <label for="minutesVolunteered">Minutes</label>
                                                    <input type="number" class="form-control" id="minutesVolunteered" placeholder="Enter Spent Minutes" min="0" max="59" name="minute" value="{{ date('i', strtotime($timesheet->time)) }}">
                                                </div>
                                                <div class="form-group  mt-3">
                                                ...
                                                <div id="edittimeentry-error-{{ $timesheet->timesheet_id }}" class="alert alert-danger" role="alert" style="display: none;"></div>
                                                <div class="container">
                                                    <div class=" d-flex mt-3 justify-content-end">
                                                        <button type="button" class="btn px-4 btn-outline-secondary rounded-pill" data-dismiss="modal">Cancel</button>&nbsp;&nbsp;
                                                        <button type="button" class="btn px-4 btn-outline-warning rounded-pill edit-timesheet-btn" data-timesheet-id="{{ $timesheet->timesheet_id }}">Submit
                                                        </button>
                                                    </div>
                                                </div>
                                            </form>
                            ...
                            <button type="button" data-toggle="modal" data-target="#deleteModal-{{ $timesheet->timesheet_id }}" class="btn btn-white">
            ...
            <div class="modal fade" id="volunteerhourModal" tabindex="-1" aria-labelledby="volunteerhourModalLabel" aria-hidden="true" role="dialog">
                <div class="modal-dialog  modal-xl modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header" style="border-bottom: none;">
                        ...
                        <div class="modal-body">
                            <form id="timesheetForm">
                                ...
                                <div class="form-group  mt-3">
                                    <label for="dateVolunteered">Date Volunteered</label>
                                    <input type="date" class="form-control" id="dateVolunteered" name="date_volunteered">
                                </div>
                                <div class="form-group  mt-3">
                                    <label for="hoursVolunteered">Hours</label>
                                    <input type="number" class="form-control" id="hoursVolunteered" placeholder="Enter Spent Hours" min="0" name="hour">
                                </div>
                                <div class="form-group  mt-3">
                                    <label for="minutesVolunteered">Minutes</label>
                                    <input type="number" class="form-control" id="minutesVolunteered" placeholder="Enter Spent Minutes" min="0" max="59" name="minute">
                                </div>
                                <div class="form-group  mt-3">
                                    <label for="messageTextarea">Message</label>
                                ...
                                <input type="hidden" id="user_id" name="user_id" value="{{ Auth::user()->user_id }}">
                                <div id="timeentry-error" class="alert alert-danger" role="alert" style="display: none;"></div>
                                <div class="container">
                                    <div class=" d-flex mt-3 justify-content-end">
                                        <button type="button" class="btn px-4 btn-outline-secondary rounded-pill" data-dismiss="modal">Cancel</button>&nbsp;&nbsp;
                                        <button type="button" id="submitTimesheetBtn" class="btn px-4 btn-outline-warning rounded-pill">
                                            Submit</button>
                                    </div>
                                </div>
                            </form>
        ...
        <div class="col-lg-5 border ms-5 mt-3">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="modal fade" id="editVolunteerGoalModal-{{ $timesheet->timesheet_id }}" tabindex="-1" role="dialog" aria-labelledby="volunteerModalLabel" aria-hidden="true">
                                <div class="modal-dialog  modal-xl modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form id="editGoalTimesheetForm-{{ $timesheet->timesheet_id }}" method="POST">
                                                @csrf
                                                @method('PUT')
                                                <div class="form-group">
                                                    <label for="missionSelect">Mission</label>
                                                ...
                                                <div class="form-group mt-3">
                                                    ...
                                                    <input type="text" class="form-control" id="action" placeholder="Enter Actions" name="action" value="{{ $timesheet->action }}">
                                                </div>
                                                <div class="form-group mt-3">
                                                    <label for="dateVolunteered">Date Volunteered</label>
                                                    <input type="date" class="form-control" id="dateVolunteered" name="date_volunteered" value="{{ \carbon\carbon::parse($timesheet->date_volunteered)->format('Y-m-d') }}">
                                                ...
                                                <div id="editgoalentry-error-{{ $timesheet->timesheet_id }}" class="alert alert-danger" role="alert" style="display: none;"></div>
                                                <div class="container">
                                                    <div class=" d-flex mt-3 justify-content-end">
                                                        <button type="button" class="btn px-4 btn-outline-secondary rounded-pill" data-dismiss="modal">Cancel</button>&nbsp;&nbsp;
                                                        <button type="button" data-timesheet-id="{{ $timesheet->timesheet_id }}" class="btn px-4 btn-outline-warning rounded-pill edit-goal-timesheet-btn">
                                                            Submit</button>
                                                    </div>
                                                </div>
                                            </form>
            ...
            <div class="modal fade" id="volunteergoalModal" tabindex="-1" role="dialog" aria-labelledby="volunteerModalLabel" aria-hidden="true">
                <div class="modal-dialog  modal-xl modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header" style="border-bottom: none;">
                        ...
                        <div class="modal-body">
                            <form id="goaltimesheetForm">
                                ...
                                <div class="form-group mt-3">
                                    <label for="action">Action</label>
                                    <input type="text" class="form-control" id="action" placeholder="Enter Actions" name="action">
                                </div>
                                <div class="form-group mt-3">
                                    <label for="dateVolunteered">Date Volunteered</label>
                                    <input type="date" class="form-control" id="dateVolunteered" name="date_volunteered">
                                ...
                                <div id="goalentry-error" class="alert alert-danger" role="alert" style="display: none;"></div>
                                <div class="container">
                                    <div class=" d-flex mt-3 justify-content-end">
                                        <button type="button" class="btn px-4 btn-outline-secondary rounded-pill" data-dismiss="modal">Cancel</button>&nbsp;&nbsp;
                                        <button type="button" id="submitgoalTimesheetBtn" class="btn px-4 btn-outline-warning rounded-pill">
                                            Submit</button>
                                    </div>
                                </div>
                            </form>
