            ...
            <div id="gridViewContent" class="row gx-2 " id="missions">
                @foreach ($data as $item)
                    ...
                    <div class="card col-lg-6 col-md-12 col-xxl-4 col-xl-6 border-0  m-3  text-center"
                        style=" box-shadow: rgba(14, 30, 37, 0.12) 0px 2px 4px 0px, rgba(14, 30, 37, 0.32) 0px 2px 16px 0px; border-radius:20px;"
                        id="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="py-3">
                            ...
                            <div class="text-center" style="margin-top: -14px">
                                <small class="p-2 fs-6 border from_untill" id="deadline">From
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            @if (count($item->missionApplication->where('user_id', $user_id)) === 0)
                                <button type="button" id="mission_application_btn_{{ $item->mission_id }}"
                                    ...
                                    class="btn btn-lg fs-6 apply-btn"> Apply <i
                            ...
                            <a href="{{ route('mission-page', $item->mission_id) }}">
                                <button style="display: none;" id="mission_detail_btn_{{ $item->mission_id }}"
                                    class="mx-2 fs-6 btn btn-outline apply-btn px-2" style="width: fit-content"> View
