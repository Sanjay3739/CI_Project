...
class MissionController extends Controller
{
    ...
    public function update(UpdateMissionRequest $request, $id): RedirectResponse
    {
        ...
        return redirect()->route('mission.index')->with('success', 'Mission has been updated successfully');
    }
    ...
    public function destroy($id): RedirectResponse
    {
        ...
        $mission->delete();
        return back()->with('success', 'Mission has been deleted successfully');
    }
}
