...
Route::get('/mission-applications', [MissionApplicationController::class, 'index'])->name('mission-applications.index');
Route::put('/mission-applications/{missionApplication}', [MissionApplicationController::class, 'update'])->name('mission-applications.update');
Route::delete('/mission-applications/{missionApplication}', [MissionApplicationController::class, 'destroy'])->name('mission-applications.destroy');
